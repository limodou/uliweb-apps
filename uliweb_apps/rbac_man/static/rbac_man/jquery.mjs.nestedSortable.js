	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		serialize: function(options) {
			...
			var o = $.extend({}, this.options, options),
				...
				result = [];
			var idName = o.idField || 'id',
				parentName = o.parentField || '_parent',
				orderName = o.orderField || 'order',
				parentEmptyValue = o.parentEmpty || 0;

			$(items).each(function(i, v) {
				var res = ($(o.item || this).attr(idName) || ""),
						//.match(o.expression || (/(.+)[-=_](.+)/)),
					pid = ($(o.item || this).parent(o.listType)
						.parent(o.items)
						.attr(idName) || parentEmptyValue)
						//.match(o.expression || (/(.+)[-=_](.+)/));
				var d = {};
				d[idName] = res
				d[parentName] = pid
